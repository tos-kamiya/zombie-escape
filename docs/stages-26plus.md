...
| Spiky Plant | <img src="../imgs/exports/houseplant.png" width="80"> | Stage 28 | In its normal state, humanoids move more slowly on it. Zombies get trapped in it and remain as trapped threats on that tile. |
