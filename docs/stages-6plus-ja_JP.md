...
タイトル画面のステージ一覧はページ分割されています。左右キーでページを切り替えます。

後続ページの解放条件:
- ステージ1〜5をすべてクリアすると、ステージ6〜15のページが解放されます。
- 各ページで5ステージ以上クリアすると、次ページが解放されます。
- 以降も同じ条件です（例: ステージ6〜15で5つ以上クリアすると、ステージ16〜25が解放）。
