...
STAGES: list[Stage] = [
    ...
    Stage(
        ...
        moving_floor_zones={
            "up": [(12, 14, 1, 5), (23, 14, 1, 5), (34, 14, 1, 5)],
            "down": [(12, 2, 1, 5), (23, 2, 1, 5), (34, 2, 1, 5)],
            "left": [(3, 11, 19, 1), (25, 11, 19, 1)],
            "right": [(3, 9, 19, 1), (25, 9, 19, 1)],
        },
        pitfall_zones=[(17, 4, 2, 2), (39, 4, 2, 2), (6, 15, 2, 2), (28, 15, 2, 2)],
        fall_spawn_zones=[(6, 4, 2, 2), (28, 4, 2, 2), (17, 15, 2, 2), (39, 15, 2, 2)],
        buddy_required_count=1,
    ),
]
