...
STAGES: list[Stage] = [
    ...
    Stage(
        id="stage_gimmick_test",
        name_key="stages.stage_gimmick_test.name",
        description_key="stages.stage_gimmick_test.description",
        available=True,
        cell_size=50,
        grid_cols=20,
        grid_rows=20,
        ...
        exterior_spawn_weight=0.6,
        interior_spawn_weight=0.2,
        interior_fall_spawn_weight=0.2,
        houseplant_density=0.03,
        houseplant_zones=[(15, 10, 1, 3)],
        puddle_density=0.05,
        puddle_zones=[(5, 5, 3, 3)],
        zombie_normal_ratio=0.4,
