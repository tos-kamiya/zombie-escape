...
from .models import FuelObjective, Stage
...
STAGES: list[Stage] = [
    ...
    Stage(
        ...
        available=True,
        fuel_objective=FuelObjective.FUEL_CAN,
    ...
    Stage(
        ...
        zombie_wall_hugging_ratio=0.0,
        zombie_dog_ratio=0.0,
        initial_flashlight_count=2,
        initial_shoes_count=0,
        waiting_car_target_count=1,
        zombie_decay_duration_frames=ZOMBIE_DECAY_DURATION_FRAMES * 3,
    ...
    Stage(
        ...
        zombie_tracker_ratio=0.1,
        zombie_wall_hugging_ratio=0.1,
