...
STAGES: list[Stage] = [
    ...
    Stage(
        ...
        moving_floor_zones={
            "up": [(12, 15, 1, 5), (23, 15, 1, 5), (34, 15, 1, 5)],
            "down": [(12, 3, 1, 5), (23, 3, 1, 5), (34, 3, 1, 5)],
            "left": [(3, 12, 19, 1), (25, 12, 19, 1)],
            "right": [(3, 10, 19, 1), (25, 10, 19, 1)],
        },
        pitfall_zones=[(17, 5, 2, 2), (39, 5, 2, 2), (6, 16, 2, 2), (28, 16, 2, 2)],
        fall_spawn_zones=[(6, 5, 2, 2), (28, 5, 2, 2), (17, 16, 2, 2), (39, 16, 2, 2)],
        buddy_required_count=1,
