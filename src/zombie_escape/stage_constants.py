...
STAGES: list[Stage] = [
    ...
    Stage(
        ...
        wall_algorithm="normal.40%",
        requires_fuel=True,
        initial_flashlight_count=10,
        fuel_spawn_count=1,
    ...
    Stage(
        ...
        patrol_bot_spawn_rate=0,
        zombie_normal_ratio=1.0,
        zombie_tracker_ratio=0.0,
        zombie_wall_hugging_ratio=0.0,
        zombie_decay_duration_frames=ZOMBIE_DECAY_DURATION_FRAMES * 2,
        moving_floor_zones={
            "up": [(5, 4, 14, 1), (7, 6, 10, 1), (9, 8, 6, 1), (11, 10, 2, 1)],
            "down": [(10, 13, 4, 1), (8, 15, 8, 1), (6, 17, 12, 1), (4, 19, 16, 1)],
            "left": [(5, 5, 1, 13), (7, 7, 1, 9), (9, 9, 1, 5), (11, 11, 1, 1)],
            "right": [(19, 4, 1, 15), (17, 6, 1, 11), (15, 8, 1, 7), (13, 10, 1, 3)],
        },
        pitfall_zones=[(3, 2, 19, 1), (3, 3, 1, 17), (21, 3, 1, 19), (3, 21, 18, 1)],
        fall_spawn_zones=[
            (12, 5, 1, 1),
            (12, 9, 1, 1),
            (4, 11, 1, 1),
