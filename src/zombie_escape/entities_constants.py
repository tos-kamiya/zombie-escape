...
ZOMBIE_LINEFORMER_SPEED_MULTIPLIER = 1.5
ZOMBIE_LINEFORMER_JOIN_RADIUS = 50
ZOMBIE_LINEFORMER_FOLLOW_DISTANCE = ZOMBIE_RADIUS * 3.5
ZOMBIE_LINEFORMER_FOLLOW_TOLERANCE = ZOMBIE_RADIUS * 0.6
ZOMBIE_LINEFORMER_TARGET_LOST_MS = 1200
ZOMBIE_LINEFORMER_JOIN_COOLDOWN_MS = 900
ZOMBIE_LINEFORMER_MAX_CHAIN_DEPTH = 64
