...
# --- Houseplant settings ---
HOUSEPLANT_HEALTH = 300
HOUSEPLANT_RADIUS = 8
HOUSEPLANT_COLLISION_RADIUS = 8
HOUSEPLANT_HUMANOID_SPEED_FACTOR = 0.2
HOUSEPLANT_CAR_SPEED_FACTOR = 0.2

# --- Puddle settings ---
PUDDLE_SPEED_FACTOR = 0.3
ZOMBIE_CONTAMINATED_SPEED_FACTOR = HOUSEPLANT_HUMANOID_SPEED_FACTOR
TRAPPED_ZOMBIE_SLOW_FACTOR = HOUSEPLANT_HUMANOID_SPEED_FACTOR
