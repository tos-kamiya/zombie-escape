...
<!-- - **Stage 5: Survive Until Dawn** — どの車も燃料切れ。実時間で20分耐え切るあいだ、画面外でもプレイヤーの近くにゾンビが湧き続け、安全地帯が崩壊していく。`Shift` キーを押せばゲーム全体を4倍速で進められる。夜明けになると屋外のゾンビは炭化し、既存の出口から徒歩で屋外に出ればクリア（車での脱出はできない）。 -->
