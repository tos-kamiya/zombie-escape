...
def test_get_fog_scale_base_is_reduced():
    ...
    scale = render._get_fog_scale(render_assets, None, flashlight_count=0)
...
def test_get_fog_scale_single_flashlight_restores_default_radius():
    render_assets = build_render_assets(DEFAULT_TILE_SIZE)
    scale = render._get_fog_scale(render_assets, None, flashlight_count=1)
...
def test_get_fog_scale_multiple_flashlights_apply_bonus():
    render_assets = build_render_assets(DEFAULT_TILE_SIZE)
    scale = render._get_fog_scale(render_assets, None, flashlight_count=2)
